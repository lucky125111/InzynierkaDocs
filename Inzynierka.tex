...
\begin{description}
	...
	\begin{minipage}{\linewidth}
		\centering
		\includegraphics[width=0.5\textwidth,angle=90]{segmentation/example_MRI_image.png}
...
\begin{minipage}{\linewidth}
	\centering
	\includegraphics[width=0.5\textwidth,angle=90]{segmentation/example_mask.png}
	\captionof{figure}{Przykładowy obraz z badania MRI}
\end{minipage}
...
\begin{figure}[htb]
	...
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{segmentation/segmentation_train_1.png}
		\caption{Obraz wejściowy}
		\label{fig:1}
	\end{subfigure}\hfil % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{segmentation/segmentaion_mask_1.png}
		\caption{Poprawna maska}
		\label{fig:2}
	\end{subfigure}\hfil % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{segmentation/pred_mask_1.png}
	...
	\medskip
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{segmentation/segmentation_train_2.png}
		\caption{Obraz wejściowy}
		\label{fig:4}
	\end{subfigure}\hfil % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{segmentation/pred_mask_2.png}
		\caption{Poprawna maska}
		\label{fig:5}
	\end{subfigure}\hfil % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{segmentation/segmentation_mask_2.png}
		\caption{Predykcja maski}
		\label{fig:6}
	\end{subfigure}
...
\begin{figure}[htb]
	\centering % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{Mask/1/maska.png}
		\caption{Maska przykład 1}
		\label{fig:1}
	\end{subfigure}\hfil % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{Mask/1/square.png}
	...
	\medskip
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{Mask/1/hull.png}
...
\begin{figure}[htb]
	\centering % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{Mask/2/mask.png}
		\caption{Maska przykład 2}
		\label{fig:1}
	\end{subfigure}\hfil % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{Mask/2/square.png}
	...
	\medskip
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{Mask/2/biggest.png}
		\caption{Maska przykład 2 Otoczka wokół największego elementu}
		\label{fig:3}
	\end{subfigure}\hfil % <-- added
	\begin{subfigure}{0.25\textwidth}
		\includegraphics[width=\linewidth,angle=90]{Mask/2/hull.png}
...
\begin{minipage}{\linewidth}
	...
	\captionof{figure}{Wartości obliczone wszystkimi algorytmami}
\end{minipage}
...
Otoczka największa	    & 89        & 99        & 79\%	            & 41	        & 134           \\ \hline
Opisane na prostokącie	& 149       & 139        & 974\%	            & 95	        & 325           \\ \hline
Otoczka	                & 22        & 24        & 24\%	            & 12	            & 39            \\ \hline

\end{tabular}
\label{Analiza statystyczna algorytmów}
\end{table}

Z zaproponowanych algorytmów jedynym który osiągnął większa dokładność niż algorytm aproksymujący elipsoidą jest algorytm znajdujący otoczkę wypukłą dla całej maski. Osiągneliśmy poziom około 3 $cm^3$  różnicy średnich względem sumy voxeli (17\%). Pokazuje to, że istnieją lepsze algorytmy niż obecnie najczęściej stosowany.
