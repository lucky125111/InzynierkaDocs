...
\begin{description}
   ...
   Każdy blok podwaja liczbę konwolucji oraz zmniejsza rozmiar przestrzenny o  połowę.
	...
	\begin{description}
		\item [UpSampling2D] 2x2 Warstwa powiększająca <TODO>
		\item [Conv2D] 3x3 Warstwa konwolucyjna + funkcja aktywacji ReLu
...
Po augmentacji obrazów została wykonana \textit{cross walidacja} <TODO> parametrów uczenia podając liczbę epok równą 30 oraz \textit{batch\_size} wynoszący 32.
