...
\par
//todo kuba  Wejdźcie głębiej w temat: 1. Jakie narzędzia są teraz wykorzystywane? 2. Kto je dostarcza? 3. Jakie są metody wspomagania obecnie dostarczane? 4. Jakie są możliwości wspomagania? 5. Kto je dostarcza? To co napisaliście jest zbyt powierzchowne. NIe zawsze! Niektóre DICOM viewery mają zintegrowane narzędzia do wspomagania (np. automatyczne wykrywanie i oznaczanie zmian w płucach - one są drobne i jest ich dużo). Musicie do tego dojść
