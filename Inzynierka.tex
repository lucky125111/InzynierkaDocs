...
\begin{minipage}[h]{\linewidth}
	...
	\captionof{figure}{PSA względem oceny w skali Gleason}
\end{minipage}
\\
...
\begin{minipage}[H]{\linewidth}
	...
	\captionof{figure}{Przykład 1 wyników automatycznej segmentacji}
	\label{przy1}
\end{minipage}
...
\begin{minipage}[H]{\linewidth}
	...
	\captionof{figure}{Przykład 2 wyników automatycznej segmentacji}
	\label{przy2}
\end{minipage}
...
\centering
\begin{tabular}{|l|c|c|c|c|c|} \hline  
Algorytm	            & Średnia	& Mediana	& Odchylenie	& Max  	& Min \\ \hline
...
\begin{minipage}[h]{\linewidth}
	...
	\captionof{figure}{Kalkulacja objętości}
\end{minipage}
...
\bibitem[15] {psaCorrelation} \emph {Korelacja między PSA a złośliwością}, 
\path{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4186957/}
